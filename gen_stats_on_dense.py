...
from models.dense_mnist import mnistDense
...
for attack_type in [LinfPGDAttack]:
...
pk.dump(stats, open('tmp/stats_linf_fine_dense_sharp.dat', 'wb'), protocol=pk.HIGHEST_PROTOCOL)
